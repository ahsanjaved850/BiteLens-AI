...
const STAT_ITEMS = [
  { value: "4w", label: "avg. visible\nface glow" },
  { value: "3×", label: "skin confidence\nboost reported" },
];

interface FaceChangeProps {
  isActive?: boolean;
}

export const FaceChange: React.FC<FaceChangeProps> = ({ isActive = true }) => {
      ...
      <View style={s.content}>
        ...
        >
          <Text style={s.headline}>
            A young glow,{"\n"}
            <Text style={s.headlineAccent}>as you transform.</Text>
          </Text>
        </Animated.View>
        ...
        >
          <Image
            source={require("@/assets/images/Onboarding/facetrans.png")}
            resizeMode="cover"
            style={s.image}
          />
        </Animated.View>
        ...
        >
          ...
          <Text style={s.insightText}>
            With transformation comes a{" "}
            <Text style={s.insightBold}>visible glow</Text>. Witness the
