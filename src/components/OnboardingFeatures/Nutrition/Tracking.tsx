...
const OPTIONS = [
  {
    label: "Frequently track",
    value: "2",
    icon: require("@/assets/images/icons/confident.png"),
  },
  {
    label: "Occasionally track",
    value: "3",
...
const BEHIND_TEXT =
  "Tracking Your Diet: Understanding how to track your diet and calorie intake is essential for maintaining a healthy lifestyle. It helps you stay accountable and make informed decisions about your food choices.";

export const Tracking: React.FC<TrackingProps> = ({ onValidationChange }) => {
  ...
  return (
    <View style={s.root}>
      ...
      >
        {/*  Title  */}
        <Text style={s.title}>
          Have you ever tried tracking{"\n"}your diet or calories?
        </Text>
