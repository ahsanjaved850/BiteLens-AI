...
interface YoyoEffectProps {
  isActive?: boolean;
}

export const YoyoEffect: React.FC<YoyoEffectProps> = ({ isActive = true }) => {
      ...
      <View style={s.content}>
        ...
        >
          <Text style={s.headline}>
            Improper ways of weightloss always lead {"\n"}
            <Text style={s.headlineAccent}> to bad cycle!</Text>
          </Text>
        </Animated.View>
        ...
        >
          <Image
            source={require("@/assets/images/Onboarding/cycle.png")}
            resizeMode="cover"
            style={s.image}
          />
        </Animated.View>
